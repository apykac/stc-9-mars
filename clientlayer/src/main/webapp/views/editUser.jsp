                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="permissionGroup">
                                        ...
                                        <option ${user.permissionGroup == 'ROLE_ADMIN' ? "selected" : ""}
                                                value="ROLE_ADMIN">Admin
                                        </option>
                                        <option ${user.permissionGroup == 'ROLE_TEACHER' ? "selected" : ""}
                                                value="ROLE_TEACHER">Teacher
                                        </option>
                                        <option ${user.permissionGroup == 'ROLE_STUDENT' ? "selected" : ""}
                                                value="ROLE_STUDENT">Student
                                        </option>
                                    </select>
                                </div>
                            </div>
