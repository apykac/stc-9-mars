...
public class UserServiceImplTest {
    ...
    @Test
    public void addUserByParamCorrectDataTest() {
        ...
        PowerMockito.when(userDao.addUser(Mockito.any(User.class))).thenReturn(false);
        Assert.assertFalse(userService.addUserByParam(createLegalMap(false)));
    }
    ...
    public void getStudentsByGroupIdCorrectDataTest() {
        ...
        PowerMockito.when(userDao.getStudentsByGroupId(1)).thenReturn(list);
        Assert.assertEquals(list, userService.getStudentsByGroupId(1));
    }

    @Test
    public void getAllStudentsByGroupIdIncorrectDataTest() {
        List<User> emptyList = new ArrayList<>();
        Assert.assertEquals(emptyList, userService.getStudentsByGroupId(-1));
        Assert.assertEquals(emptyList, userService.getStudentsByGroupId(null));
    }
    ...
    @Test
    public void findUserByIdWithSubjectListCorrectDataTest() {
        User user = new User();
        PowerMockito.when(userService.findUserByIdWithSubjectList(1)).thenReturn(user);
        Assert.assertEquals(user, userService.findUserByIdWithSubjectList(1));
    }

    @Test
    public void findUserByIdWithSubjectListIncorrectDataTest() {
        Assert.assertNull(userService.findUserByIdWithSubjectList(1));
    }

    @Test
    public void getAllStudentsTest() {
        List<User> students = new ArrayList<>();
        PowerMockito.when(userDao.getAllStudents()).thenReturn(students);
        Assert.assertEquals(students, userService.getAllStudents());
    }
}
